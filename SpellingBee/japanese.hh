...
const static std::vector<JapaneseWord> japaneseWords = {{"にんげん", "人間 ", "human being", "ningen"},
...
{"み", "実", "fruit ", "mi"},
{"き", "木", "tree ", "ki"},
{"は or はっぱ", "葉 or 葉っぱ", "leaf ", "ha"},
{"ね or ねっこ", "根 or 根っ子", "root ", "ne"},
{"くき", "茎", "stem ", "kuki"},
